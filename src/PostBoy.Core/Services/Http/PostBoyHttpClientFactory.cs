...
namespace PostBoy.Core.Services.Http;

public interface IPostBoyHttpClientFactory : IScopedDependency
{
...
public class PostBoyHttpClientFactory : IPostBoyHttpClientFactory
{
    private readonly ILifetimeScope _scope;

    public PostBoyHttpClientFactory(ILifetimeScope scope)
    {
        _scope = scope;
    }
